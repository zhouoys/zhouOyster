...
// 使用commonjs导入
const {add,sub,multiply} = __webpack_require__(1)
console.log('add:',add(5,8));
console.log('sub:',sub(5,8));
console.log('multiply:',multiply(5,8))
// 使用es6模块化导入

console.log('name:',__WEBPACK_IMPORTED_MODULE_0__info_js__["b" /* name */]);
console.log('func:',Object(__WEBPACK_IMPORTED_MODULE_0__info_js__["a" /* func */])());
